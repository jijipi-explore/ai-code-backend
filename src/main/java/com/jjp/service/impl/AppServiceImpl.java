...
import com.jjp.ai.AiCodeGenTypeRoutingService;
import com.jjp.constant.AppConstant;
import com.jjp.core.AiCodeGeneratorFacade;
import com.jjp.core.builder.VueProjectBuilder;
import com.jjp.core.handle.StreamHandlerExecutor;
...
import com.jjp.model.enums.ChatHistoryMessageTypeEnum;
...
import com.jjp.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        ThrowExceptionUtils.throwIf(app == null, ErrorCode.NOT_FOUND_ERROR, "应用不存在");
...
//        });
    ...
    public String deployApp(Long appId, User loginUser) {
        // 1. 参数校验
        ThrowExceptionUtils.throwIf(appId == null || appId <= 0, ErrorCode.PARAMS_ERROR, "应用 ID 不能为空");
        ThrowExceptionUtils.throwIf(loginUser == null, ErrorCode.NOT_LOGIN_ERROR, "用户未登录");
        // 2. 查询应用信息
        App app = this.getById(appId);
        ThrowExceptionUtils.throwIf(app == null, ErrorCode.NOT_FOUND_ERROR, "应用不存在");
        ...
        if (codeGenTypeEnum == CodeGenTypeEnum.VUE_PROJECT) {
            ...
            ThrowExceptionUtils.throwIf(!buildSuccess, ErrorCode.SYSTEM_ERROR, "Vue 项目构建失败，请检查代码和依赖");
            // 检查 dist 目录是否存在
            File distDir = new File(sourceDirPath, "dist");
            ThrowExceptionUtils.throwIf(!distDir.exists(), ErrorCode.SYSTEM_ERROR, "Vue 项目构建完成但未生成 dist 目录");
            // 将 dist 目录作为部署源
            sourceDir = distDir;
        ...
        ThrowExceptionUtils.throwIf(!updateResult, ErrorCode.OPERATION_ERROR, "更新应用部署信息失败");
        // 10. 返回可访问的 URL
    ...
    public boolean removeByAppId(Long appId) {
        ...
        // 删除应用
        int deleteFlag = this.getMapper().deleteById(appId);
        return deleteFlag > 0;
    }
    ...
    public void generateAppScreenshotAsync(Long appId, String appUrl) {
        ...
        Thread.startVirtualThread(() -> {
            ...
            ThrowExceptionUtils.throwIf(!updated, ErrorCode.OPERATION_ERROR, "更新应用封面字段失败");
        });
    }
    ...
    public Long createApp(AppAddRequest appAddRequest, User loginUser) {
        ...
        ThrowExceptionUtils.throwIf(StrUtil.isBlank(initPrompt), ErrorCode.PARAMS_ERROR, "初始化 prompt 不能为空");
        // 构造入库对象：将请求参数复制到App对象中
        App app = new App();
